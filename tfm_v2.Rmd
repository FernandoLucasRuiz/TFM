...
```{r}
save(umap.ad, covs2, covs2.casos, mat_exp_alz_genes, mUMAP1.pos, outliers.umap1, outliers.umap2, file = "mi_entorno_EnrDif.RData")
```
...
```{r}
saveRDS(important.genes.umap1pos, "important.genes.umap1pos.RDS")
```
