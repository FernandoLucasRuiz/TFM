...
-   [ ] De los genes con más loadings en cada caso ver si existe la posibilidad de ver enriquecimiento diferencial
...
-   [ ] Hacer upset plot
    ...
    -   [ ] Solamente con enfermos

------------------------------------------------------------------------

# Preguntas

-   [ ] Cuando hago el análisis estadístico es mejor hacerlo un grupo con el resto o un grupo con los "not in both". Por ejemplo mPC1 negative con mPC1 positivo + mPC2 positivo+mPC2 negativo+not in both, o mPC1 negative con solamente Not in both
